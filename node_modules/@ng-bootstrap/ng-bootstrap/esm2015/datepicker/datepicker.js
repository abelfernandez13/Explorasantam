...
function NgbDatepicker_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const date_r423 = ctx.date;
    const currentMonth_r424 = ctx.currentMonth;
    const selected_r425 = ctx.selected;
    const disabled_r426 = ctx.disabled;
    const focused_r427 = ctx.focused;
    ɵngcc0.ɵɵproperty("date", date_r423)("currentMonth", currentMonth_r424)("selected", selected_r425)("disabled", disabled_r426)("focused", focused_r427);
} }
function NgbDatepicker_ng_template_2_div_0_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const month_r429 = ɵngcc0.ɵɵnextContext().$implicit;
    const ctx_r431 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate2(" ", ctx_r431.i18n.getMonthFullName(month_r429.number, month_r429.year), " ", ctx_r431.i18n.getYearNumerals(month_r429.year), " ");
} }
function NgbDatepicker_ng_template_2_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const month_r429 = ctx.$implicit;
    const ctx_r428 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r428.navigation === "none" || ctx_r428.displayMonths > 1 && ctx_r428.navigation === "select");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("month", month_r429.firstDate);
} }
function NgbDatepicker_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r418.model.months);
} }
function NgbDatepicker_ngb_datepicker_navigation_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("navigate", function NgbDatepicker_ngb_datepicker_navigation_5_Template_ngb_datepicker_navigation_navigate_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r434); const ctx_r433 = ɵngcc0.ɵɵnextContext(); return ctx_r433.onNavigateEvent($event); })("select", function NgbDatepicker_ngb_datepicker_navigation_5_Template_ngb_datepicker_navigation_select_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r434); const ctx_r435 = ɵngcc0.ɵɵnextContext(); return ctx_r435.onNavigateDateSelect($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r419 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("date", ctx_r419.model.firstDate)("months", ctx_r419.model.months)("disabled", ctx_r419.model.disabled)("showSelect", ctx_r419.model.navigation === "select")("prevDisabled", ctx_r419.model.prevDisabled)("nextDisabled", ctx_r419.model.nextDisabled)("selectBoxes", ctx_r419.model.selectBoxes);
} }
...
NgbDatepicker.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NgbDatepicker, selectors: [["ngb-datepicker"]], contentQueries: function NgbDatepicker_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        const _r417 = ɵngcc0.ɵɵreference(3);
        ɵngcc0.ɵɵadvance(5);
        ɵngcc0.ɵɵproperty("ngIf", ctx.navigation !== "none");
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵclassProp("ngb-dp-months", !ctx.contentTemplate);
        ɵngcc0.ɵɵadvance(2);
        ɵngcc0.ɵɵproperty("ngTemplateOutlet", (ctx.contentTemplate == null ? null : ctx.contentTemplate.templateRef) || _r417);
        ɵngcc0.ɵɵadvance(1);
