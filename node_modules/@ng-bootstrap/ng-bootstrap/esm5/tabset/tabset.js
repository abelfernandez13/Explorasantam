...
function NgbTabset_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function NgbTabset_li_1_Template_a_click_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r611); var tab_r608 = ctx.$implicit; var ctx_r610 = ɵngcc0.ɵɵnextContext(); ctx_r610.select(tab_r608.id); return $event.preventDefault(); });
    ɵngcc0.ɵɵtext(2);
    ɵngcc0.ɵɵtemplate(3, NgbTabset_li_1_ng_template_3_Template, 0, 0, "ng-template", 6);
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var tab_r608 = ctx.$implicit;
    var ctx_r606 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassProp("active", tab_r608.id === ctx_r606.activeId)("disabled", tab_r608.disabled);
    ɵngcc0.ɵɵproperty("id", tab_r608.id);
    ɵngcc0.ɵɵattribute("tabindex", tab_r608.disabled ? "-1" : undefined)("aria-controls", !ctx_r606.destroyOnHide || tab_r608.id === ctx_r606.activeId ? tab_r608.id + "-panel" : null)("aria-selected", tab_r608.id === ctx_r606.activeId)("aria-disabled", tab_r608.disabled);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", tab_r608.title, "");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", tab_r608.titleTpl == null ? null : tab_r608.titleTpl.templateRef);
} }
...
function NgbTabset_ng_template_3_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    var tab_r612 = ɵngcc0.ɵɵnextContext().$implicit;
    var ctx_r613 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵclassMapInterpolate1("tab-pane ", tab_r612.id === ctx_r613.activeId ? "active" : null, "");
    ɵngcc0.ɵɵpropertyInterpolate1("id", "", tab_r612.id, "-panel");
    ɵngcc0.ɵɵattribute("aria-labelledby", tab_r612.id);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", tab_r612.contentTpl == null ? null : tab_r612.contentTpl.templateRef);
} }
function NgbTabset_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ...
    var tab_r612 = ctx.$implicit;
    var ctx_r607 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r607.destroyOnHide || tab_r612.id === ctx_r607.activeId);
} }
var nextId = 0;
/**
